...
function createProductoRoutes(productoController) {
  ...
  router.post('/', verifyToken, verifyVendedor, uploadProductImage.single('imageFile'), productRules, handleValidation, (req, res) => productoController.crear(req, res));
  router.put('/:id_producto', verifyToken, verifyVendedor, uploadProductImage.single('imageFile'), productIdParamRule, productRules, handleValidation, (req, res) => productoController.actualizar(req, res));
