 ...
 */
export const COLOMBIA_DEPARTMENTS_AND_MUNICIPALITIES = {
  'Amazonas': [
  ...
  'Antioquia': [
    ...
    'Arboletes', 'Argelia', 'Armenia Mantequilla', 'Barbosa', 'Bello',
    'Belmira', 'Betania', 'Betulia', 'Briceño', 'Buriticá', 'Cáceres',
  ...
  'Bogotá D.C.': [
    'Bogotá D.C.', 'Usaquén', 'Chapinero', 'Santa Fe', 'San Cristóbal',
  ...
  'Bolívar': [
    'El Carmen de Bolívar', 'Cartagena de Indias', 'Magangué', 'San Juan Nepomuceno',
    'San Jacinto', 'Turbaco', 'Arjona', 'María La Baja', 'Calamar', 'Mahates',
    'Zambrano', 'Córdoba Tetón', 'Santa Cruz de Mompox', 'Achí', 'Altos del Rosario',
    'Arenal', 'Arroyohondo', 'Barranco de Loba', 'Cantagallo', 'Cicuco',
    'Clemencia', 'El Guamo', 'El Peñón', 'Hatillo de Loba', 'Margarita',
    'Montecristo', 'Morales', 'Norosí', 'Pinillos', 'Regidor', 'Río Viejo',
    'San Cristóbal', 'San Estanislao', 'San Fernando', 'San Martín de Loba',
    'San Pablo', 'Santa Catalina', 'Santa Rosa', 'Santa Rosa del Sur', 'Simití',
    'Soplaviento', 'Talaigua Nuevo', 'Tiquisio', 'Turbana', 'Villanueva'
  ],
  'Boyacá': [
    'Tunja', 'Duitama', 'Sogamoso', 'Chiquinquirá', 'Paipa', 'Puerto Boyacá',
    'Villa de Leyva', 'Moniquirá', 'Samacá', 'Nobsa', 'Garagoa', 'Guateque',
    'Soatá', 'Santa Rosa de Viterbo', 'Tibasosa', 'Aquitania', 'Muzo',
    'Saboyá', 'Ventaquemada', 'Ramiriquí', 'Cómbita', 'Monguí', 'Belén',
    'Boavita', 'Chita', 'El Cocuy', 'Ráquira', 'Tenza', 'Turmequé', 'Arcabuco',
    'Berbeo', 'Betéitiva', 'Boyacá', 'Briceño', 'Buenavista', 'Busbanzá',
    'Caldas', 'Campohermoso', 'Cerinza', 'Chinavita', 'Chiquiza', 'Chiscas',
    'Chivor', 'Ciénaga', 'Coper', 'Corrales', 'Covarachía', 'Cubará', 'Cucaita',
    'Cuítiva', 'El Espino', 'Firavitoba', 'Floresta', 'Gachantivá', 'Gámeza',
    'Guacamayas', 'Guateque', 'Guayatá', 'Güicán', 'Iza', 'Jenesano', 'Jericó',
    'La Capilla', 'La Uvita', 'La Victoria', 'Labranzagrande', 'Macanal', 'Maripí',
    'Miraflores', 'Mongua', 'Motavita', 'Nuevo Colón', 'Oicatá', 'Otanche',
    'Pachavita', 'Páez', 'Pajarito', 'Panqueba', 'Paz de Río', 'Pesca',
    'Pisba', 'Quípama', 'Rondón', 'San Eduardo', 'San José de Pare', 'San Luis de Gaceno',
    'San Mateo', 'San Miguel de Sema', 'San Pablo de Borbur', 'Santana',
    'Santa María', 'Santa Sofía', 'Sativanorte', 'Sativasur', 'Siachoque',
    'Socha', 'Socotá', 'Somondoco', 'Sora', 'Soracá', 'Sotaquirá', 'Susacón',
    'Sutamarchán', 'Sutatenza', 'Tasco', 'Tenza', 'Tibaná', 'Tinjacá', 'Tipacoque',
    'Toca', 'Togüí', 'Tópaga', 'Tota', 'Tununguá', 'Turmequé', 'Tuta', 'Tutazá',
    'Umbita', 'Viracachá', 'Zetaquira'
  ],
  'Caldas': [
  ...
  'Chocó': [
    ...
    'Litoral del San Juan', 'Lloró', 'Medio Atrato', 'Medio Baudó',
  ...
  'Huila': [
    'Neiva', 'Acevedo', 'Agrados', 'Aipe', 'Algeciras', 'Altamira',
  ...
  'Nariño': [
    'Pasto', 'Albán', 'Aldana', 'Ancuya', 'Arboleda', 'Barbacoas',
    ...
    'Leiva', 'Linares', 'Los Andes', 'Magüí Payán', 'Mallama', 'Mosquera',
    'Nariño', 'Olaya Herrera', 'Ospina', 'Policarpa', 'Potosí', 'Providencia',
    'Puerres', 'Pupiales', 'Ricaurte', 'Roberto Payán', 'Samaniego', 'San Bernardo',
  ...
  'Norte de Santander': [
    ...
    'Salazar de Las Palmas', 'San Calixto', 'San Cayetano', 'Santiago', 'Sardinata',
  ...
  'Santander': [
    ...
    'Enciso', 'Floridablanca', 'Florián', 'Galán', 'Gámbita', 'Girón',
  ...
  'Sucre': [
    ...
    'San Juan de Betulia', 'San Marcos', 'San Onofre', 'San Pedro', 'Santiago de Tolú',
    'Sincé', 'Sucre', 'Toluviejo'
  ],
  'Tolima': [
  ...
  'Valle del Cauca': [
    ...
    'Buenaventura', 'Buga', 'Bugalagrande', 'Caicedonia', 'Calima El Darién',
...
export const COLOMBIAN_DEPARTMENTS = Object.keys(COLOMBIA_DEPARTMENTS_AND_MUNICIPALITIES).sort()

export const getMunicipiosPorDepartamento = (departamento) => {
  if (!departamento) return []
  return COLOMBIA_DEPARTMENTS_AND_MUNICIPALITIES[departamento] || []
}
